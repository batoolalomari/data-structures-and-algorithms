...
for each of the characters. Use the snippet as your guide for creating your templates.
 Return an array of template strings. Note: this function does not need to actually 
...
const templatingWithMustache = () => {
  ...
  characters.forEach(element => {
    ...
    let render=Mustache.render(template,element);
    templateArray.push(render);
  });
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(element => {
    ...
    {
      let value=Object.values(element.children);
      result=Boolean(value.join());
    }
  });
return result;
};
