...
Without altering the html, write a function named generateSubmitButton that
 uses jQuery to create a submit button with the text "submit" and append it to the DOM.
------------------------------------------------------------------------------------------------ */
...
const citiesAtoJ = (arr) => {
  ...
  return arr2;
    /*let arr3=element.match(regex);
    if(arr2!=null)
    {
      arr3.push(arr2.toString());
    }
